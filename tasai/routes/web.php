...
Route::group(['middleware'=>['cors']], function()
{
    ...
    Route::get('/api/topcourses', [\App\Http\Controllers\CourseController::class,'top_courses']);
...
//protected routes
    Route::group(['middleware'=>['auth:sanctum']], function(){
        ...
        Route::get('/api/getcurrentuser', [App\Http\Controllers\UserController::class, 'getCurrentUserData']);
        ...
        Route::post("/api/saveattendance", [\App\Http\Controllers\AttendanceEntryController::class, 'saveOrUpdateParticipation']);
        ...
        Route::post('/api/payment', [\App\Http\Controllers\PaymentController::class, 'process_payment']);
        //payment gateway
